    ...
    return (
        <>
            <Container className="flex flex-wrap items-center justify-center gap-8">
                <button className="bg-red-500 w-1/6 h-40 shadow-lg shadow-red-500/50 text-6xl"><h3 className="text-xl">Cash Out</h3>{red}</button>
                <button className="bg-green-500 w-1/6  h-40 shadow-lg shadow-green-500/50 text-6xl"><h3 className="text-xl">Cash In</h3>{green}</button>
                <button className="bg-yellow-500 w-1/6 h-40 shadow-lg shadow-yellow-500/50 text-6xl"><h3 className="text-xl">Remaining Amount</h3>{yellow}</button>
            </Container>
